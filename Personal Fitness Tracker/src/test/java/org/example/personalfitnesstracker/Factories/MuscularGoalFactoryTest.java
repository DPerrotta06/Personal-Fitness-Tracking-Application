 ...
 * @author danie
 */
public class MuscularGoalFactoryTest {
    
    public MuscularGoalFactoryTest() {
    }
    ...
    public void testCreateNewGoal() { //fail
        ...
        MuscularGoalFactory instance = new MuscularGoalFactory();
        MuscularGoal expResult = null;
        MuscularGoal result = instance.createNewGoal(attr);
